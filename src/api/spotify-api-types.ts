 ...
 */
export interface RecommendationTrackObject
  extends Omit<TrackObjectFull, "album"> {
 ...
 */
export interface RecommendationAlbumObject
 ...
 * POST /playlists/{playlist_id}/track
 * https://developer.spotify.com/documentation/web-api/reference/add-tracks-to-playlist
 */
export interface AddItemsToPlaylistBody {
  uris: string[];
  position: number;
}
